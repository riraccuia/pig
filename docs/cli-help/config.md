...
| mqtt_global | MQTTBrokerConfig? | true     | -                      | Default MQTT broker configuration for NAT traversal.                    |
...
| adapter            | AdapterConfig? | true     | -       | Adapter configuration specific for this tunnel. Mandatory when the direction is "listen".         |
| connect            | ConnectTarget? | true     | -       | Connect target configuration. Use with NAT traversal disabled.                                    |
| listen             | ListenTarget?  | true     | -       | Listen address to bind to. Use with NAT traversal disabled.                                       |
| tls                | TLSConfig?     | true     | -       | TLS configuration.                                                                                |
| stream_count       | int?           | true     | 0       | Number of streams to open. Valid only with streamed protocols like QUIC. Zero means the number of |
|                    |                |          |         | CPU cores.                                                                                        |
...
| ice                | ICEConfig?     | true     | -       | NAT traversal and path discovery configuration. To enable NAT traversal, set                      |
|                    |                |          |         | ICEConfig.Enabled=true.                                                                           |
| routes             | []Route?       | true     | -       | Routes to enforce once the tunnel is established.                                                 |
+--------------------+----------------+----------+---------+---------------------------------------------------------------------------------------------------+
...
| redirect_url             | string         | false    | -       | RedirectURL is the full OAuth redirect URI registered at the IdP (optional; loopback        |
...
| Field     | Type    | Optional | Default | Description                                                                                                       |
+-----------+---------+----------+---------+-------------------------------------------------------------------------------------------------------------------+
| trust_pem | string? | true     | -       | TrustPEM is the path to the trust bundle for MTLS, if not provided, the system CA will be used. In client mode,   |
|           |         |          |         | this is used to validate the server certificate. In server mode, this is used to validate client certificates.    |
...
| mqtt           | MQTTBrokerConfig? | true     | -       | Optional MQTT broker configuration to use instead of the default one.     |
+----------------+-------------------+----------+---------+---------------------------------------------------------------------------+
