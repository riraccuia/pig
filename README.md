...
I created pig as a passion project and a place to experiment with network standards and protocols that piqued my interest. 
Eventually it became the primary tool for connecting to my home when I travel. I also use it to protect my internet browsing whenever I have no other choice but to use public Wi-Fi networks. 
...
**Swappable transport protocols.** Choose from [available ones](docs/cli-help/protos.md) such as QUIC, TLS, WebSocket, DTLS, and TLS-in-ICMP (experimental) or let NAT traversal pick one automatically. There are more planned.
